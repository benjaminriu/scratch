...
#SBATCH --job-name=CAT_train
#SBATCH --output=res_CAT_train.txt
...
METHODS='catboost' #choices=['RF', 'sklearn', 'mlrnet', "regularnet", "fast_mlrnet", "fast_regularnet", "catboost","xgboost", "lgbm", "mars", "all", "best", "fast", "noCAT", "cpu"]
INTER='interrupt_CAT_trainsize.txt'
